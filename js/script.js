...
historyButton.classList.add('bg-button_bg', 'border-button_bg', 'text-primary');
historyButton.classList.remove('bg-white', 'border-gray-400', 'text-secondary');

donationButton.classList.remove('bg-button_bg', 'border-button_bg', 'text-primary');
...
document.getElementById('donation-btn').addEventListener('click', function() {
    ...
    historyButton.classList.remove('bg-button_bg', 'border-button_bg', 'text-primary');
historyButton.classList.add('bg-white', 'border-gray-400', 'text-secondary');

donationButton.classList.add('bg-button_bg', 'border-button_bg', 'text-primary');
donationButton.classList.remove('bg-white', 'border-gray-400', 'text-secondary' )
...
document.getElementById('noakhali-donate-btn').addEventListener('click', function (event) {
    ...
    if (typeof noakhaliInputMoney === 'number' && noakhaliInputMoney > 0 && myBalance >= noakhaliInputMoney) {
        // Noakhali Balance
...
document.getElementById('feni-donate-btn').addEventListener('click', function (event) {
    ...
    if (typeof feniInputMoney === 'number' && feniInputMoney > 0 && myBalance >= feniInputMoney) {
        // Noakhali Balance
...
document.getElementById('quota-movement-btn').addEventListener('click', function (event) {
    ...
    if (typeof quotaInputMoney === 'number' && quotaInputMoney > 0 && myBalance >= quotaInputMoney) {
        // Quota Balance
